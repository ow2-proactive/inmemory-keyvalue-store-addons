...
public class IntegrationTest {
    ...
    protected InMemoryKeyValueStore inMemoryKeyValueStoreStub;

    @Before
    public void setUp() throws ActiveObjectCreationException, NodeException {
        inMemoryKeyValueStoreStub = InMemoryKeyValueStore.newActive();
    }

    @After
    public void tearDown() {
        PAActiveObject.terminateActiveObject(inMemoryKeyValueStoreStub, true);
    }
